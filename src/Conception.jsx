...
const Conception = () => {
    return (
        <div className='conception-container'>
            ...
            <div className="conception-slider-container">
                <div className="conception-slide-container">

                    <div className="conception-slide-explanation">
                        <h4>sitemap (arborescence du site)</h4>
                        <div className="conception-slide-line"></div>
                        <ul>
                            <li>
                                <strong>Définir</strong> une structure logique pour les pages afin de
                                faciliter la navigation.
                            </li>
                            <i>
                                Exemple : <strong>Accueil → Produits → À propos → Blog → Contact</strong>
                            </i>
                        </ul>
                    </div>

                    <div className="conception-slide-next-button">
                        <img src="right-arrow.png" alt="bouton suivant" />
                    </div>
                </div>
                <div className='conception-slide-container'>
                    <div className='conception-slide-prev-button'>
                        <img src="left-arrow.png" alt="bouton précédent" />
                    </div>
                    <div className='conception-slide-explanation'>
